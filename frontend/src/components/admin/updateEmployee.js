...
const UpdateEmployeeModal = (props) => {
  ...
  const updateEmployee = () => {
    ...
    const body = {empId,firstName,lastName,dob, cellNo};
      ...
      <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false}>
        ...
        <Modal.Body>
          <div className="form-group needs-validation">
            ...
            <input onChange={(e) => { setEmpId(e.target.value);}}type="number"className="form-control"value={EmpId}readOnly/>
          </div>
          ...
          <div className="form-group needs-validation">
            ...
            <input onChange={(e) => {setEmail(e.target.value); }}type="text"value={employeeUpdate.email}className="form-control"readOnly/>
          </div>

          {/* ====================================dob================================= */}
          <div className="form-group needs-validation">
            <label className="form-label">Date of Birth</label>
            <input onChange={(e) => {setDob(e.target.value);}}type="date"placeholder={dob}value={dob}/>
          </div>

          {/* ====================================cell no================================= */}
          <div>
            <label className="form-label">Mobile Number</label>
            <PhoneInput className="form-control"value={cellNo} onChange={setCellNo}/>
            {cellNo.length === 13 ? (
              <div>
        ...
        <Modal.Footer>
          ...
          <Button size="sm" variant="success" onClick={updateEmployee}>Update Employee</Button>
        </Modal.Footer>
      </Modal>
    </div>
  );
