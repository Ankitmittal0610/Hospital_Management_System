...
const ReceptionistHome = () => {
  ...
  const ToggleAddNewPatientModal = () => {
    ...
    handleShow();
    console.log("value of ToggleAddNewPatientModal in function : " +addNewPatientModalFlag);
  };
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto" >
              ...
              <Nav.Link style={{marginLeft:'10%'}}>
                <Button onClick={ToggleAddNewPatientModal} variant="success" style={{width:'200%'}}> Add New Patient</Button>
              </Nav.Link>
             
              <Nav.Link style={{marginLeft:'150%'}}>
                  <input style={{borderStyle: "solid",borderRadius: "20px",marginLeft: "10px",}} placeholder="  Search by Name.." onChange={e=>{setSearch(e.target.value) }} type="text" />
              </Nav.Link>
