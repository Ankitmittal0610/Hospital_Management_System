    ...
    <div >
      ...
      <div className="d-flex justify-content-between container-fluid" style={{width:'40%'}}>
        <div className="p-2 bd-highlight">
          <Button onClick={ToggleEditPatientModal} className="btn btn-warning"> Edit Patient</Button>
        </div>

        {/* ==========================remove patient==================================== */}
        <div className="p-2 bd-highlight">
          {patientDetails.paymentStatus == "paid" ? (
            <Button onClick={() => { IncreaseBedCount(); RemovePatient();}} variant="danger"> <MdOutlineDelete />Remove Patient </Button> ) : (
        ...
        {/* ------------------------------------------------------------------------ */}
        {editPatientFlag && (
          <EditPatient patientDetails={patientDetails} toggleDataFlag={toggleDataFlag} dataChangedFlag={dataChangedFlag} setEditPatientFlag={setEditPatientFlag} handleClose={handleClose} show={show}/>)}
      </div>
      ...
      <table className="table table-hover receptionPatientTable" 
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{patientDetails.doctorFirstName +" " +patientDetails.doctorLastName}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><textarea className="form-control" value={patientDetails.patientProblem} id="exampleFormControlTextarea1"rows="2" readOnly ></textarea></td>
          </tr>
          ...
          <tr>
            ...
            <td>
              {patientDetails.paymentStatus == "paid" ? (
                <Button variant="success">{patientDetails.paymentStatus}</Button>
      ...
      <div className="p-2 bd-highlight">
          <Button variant="secondary" onClick={() => {navigate("/reception");}} >Goback</Button>
        </div>
